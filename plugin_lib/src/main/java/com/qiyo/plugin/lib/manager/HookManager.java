package com.qiyo.plugin.lib.manager;
...
import com.qiyo.plugin.lib.hcallback.PluginHandlerH;
import com.qiyo.plugin.lib.instrumentation.ComponentResolver;
import com.qiyo.plugin.lib.instrumentation.PluginInstrumentation;
 ...
 * <b>Description:</b> 在{@link Application#attachBaseContext(Context)}里面调用的 <br>
 */
